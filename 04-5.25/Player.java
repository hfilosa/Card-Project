...
public class Player{
    ...
    //Displays the public cards of the player
    public String displayVisible(){
	String ans=Name+" has ";
	...
	if (hiddenHand.size()!=0) ans+="and "+hiddenHand.size()+" in their hand";
	return ans;
    }

    //Tells the palyer what cards they hold
